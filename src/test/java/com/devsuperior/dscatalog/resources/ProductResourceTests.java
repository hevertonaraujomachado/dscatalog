...
public class ProductResourceTests {
    ...
    public void deleteShouldReturnNoContentWhenIdExists() throws Exception {
     ...
     @Test
     public void deleteShouldReturnNotFoundIdNotExist() throws Exception {
    ...
    public void updateShouldReturnNotFoundWhenDoesNotExist() throws Exception {
        ...
        ResultActions result =
                mockMvc.perform(get("/products/{id}", nonExistingId).content(jsonBody)
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON));
        result.andExpect(status().isNotFound());
    ...
    public void findByIdShouldReturnNotFoundWhenIdDoesNotExist() throws Exception {
        ...
        ResultActions result =
                mockMvc.perform(get("/products/{id}", nonExistingId).accept("application/json"));
        result.andExpect(status().isNotFound());
    }
}
